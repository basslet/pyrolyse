...
# Menge an Holz für 1 MWh Strom und Wärme
holzmenge_pro_182kwh = 293  # kg Holz für 32 kWh
stunden_pro_1mwh_waerme = 1000 / 182 # Anzahl der Stunden, um 1 MWh zu produzieren
holzmenge_pro_1mwh_waerme = holzmenge_pro_182kwh * stunden_pro_1mwh_waerme  # Holzmenge für 1 MWh
...
gesamter_kohlenstoff_pro_1mwh = holzmenge_pro_1mwh_waerme * kohlenstoffgehalt_holz
...
gebundener_kohlenstoff = gesamter_kohlenstoff_pro_1mwh - freigesetzter_kohlenstoff_pro_1mwh
...
co2_einsparung_pro_1mwh = gebundener_kohlenstoff * umrechnungsfaktor_c_zu_co2

print(f'== Emissionen pro 1MWh: ==')
print(f'Eingangsmasse Holz: {round(holzmenge_pro_1mwh_waerme, 1)} kg')
print(f'Gesamter Kohlenstoff: {round(gesamter_kohlenstoff_pro_1mwh, 1)} kg')
print(f'Freigesetzter Kohlenstoff: {round(freigesetzter_kohlenstoff_pro_1mwh, 1)} kg')
print(f'Gebundener Kohlenstoff: {round(gebundener_kohlenstoff, 1)} kg')
print(f'CO2 Emissionen: {round(co2_pro_1mwh, 1)} kg')
print(f'CO2 Einsparung: {round(co2_einsparung_pro_1mwh, 1)} kg')
