...
class EnergieGewinnung:
    ...
    def bericht(self, zeitraum_in_h=1):
        ...
        print('- Gesamtleistung pro Stunde:',h.smart_format(self.ausgangsleistung_ueber_zeitraum(zeitraum_in_h), 'kWh') )
        print('- Elektrische Netoleistung pro Stunde:',h.smart_format(self.ausgangsleistung_ueber_zeitraum(zeitraum_in_h, waerme=False), 'kWh') )
