...
Hier ist die Berechnung: [hektar_forst.py](code/hektar_forst.py)
...
Basierend auf den Berechnungen: [holzzuwachs-co2.py](code/holzzuwachs-co2.py)
...
Die Berechnungen: [kohlenstoff_bindung.py](code/kohlenstoff_bindung.py)
...
Zur Berechnung: [co2_1mwh_pyrolyse.py](code/co2_1mwh_pyrolyse.py)
...
Berechnung: [ueberpruefung_co2_pro_mwh.py](code/ueberpruefung_co2_pro_mwh.py)
